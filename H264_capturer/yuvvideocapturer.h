...
#include "webrtc/examples/peerconnection/client/yuvframegenerator.h"
#include "webrtc/examples/peerconnection/client/yuvframegenerator.cc"
...
class RawVideoCapturer : public cricket::VideoCapturer, public rtc::Thread
{
	public:
				...
				frame_index_(0)
		{
			...
			int qsize = size / 4;
			frame_generator_ = new cricket::RawFrameGenerator(width_, height_, true);
	...
	private:
		...
		cricket::RawFrameGenerator* frame_generator_;
